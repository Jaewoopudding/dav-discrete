...
def run(args, rank=None):
    ...
    gen_samples, value_func_preds, reward_model_preds, selected_baseline_preds, baseline_preds, eval_reward_model_preds, eval_base_reward_model_preds = model.controlled_decode_DPS(gen_batch_num=args.val_batch_num, sample_M=args.sample_M, guidance_scale = args.guidance_scale )
